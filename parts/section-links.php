...
<div class="link-dropdown">
	<select>
		<option value="preprimary"><a href="<?=site_url();?>/welcome-to-christopher-robin-pre-primary/">Pre-Primary (Grade 0000 - R)</a></option>
		<option value="juniorprep"><a href="<?=site_url();?>/welcome-to-the-junior-preparatory/">Junior Preparatory (Grade 1 - 3)</a></option>
		<option value="seniorprep"><a href="<?=site_url();?>/welcome-to-the-senior-preparatory/">Senior Preparatory (Grade 4 - 6)</a></option>
		<option value="highschool"><a href="<?=site_url();?>/welcome-to-the-secondary-faculty/">Secondary Faculty (Grade 7 - 12)</a></option>
	</select>
</div>
<?php if (is_front_page() == true) { ?>
	<br>
